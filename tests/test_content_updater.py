...
class TestContentUpdater:
    ...
    def test_update_interface_content_single_line(self):
        ...
        result = update_interface_content(content, Product.WOW, "110000", False, False)
...
## Title: Test Addon"""
        result = update_interface_content(
            content, Product.WOW_CLASSIC, "40401, 11504", True, False
        )
...
## Title: Test Addon"""
    ...
    def test_update_interface_content_wow_classic_era_multi(self):
        ...
        result = update_interface_content(
            content, Product.WOW_CLASSIC_ERA, "11504", True, False
        )
    ...
    def test_update_interface_content_single_line_multi_mode(self):
        ...
        result = update_interface_content(
            content, Product.WOW, "110002, 110003", False, True
        )
